// Chapter 25, exercise 4: add bitwise logical operators &, |, ^ and ~ to the
// calculator from Chapter 7

// Note how the precedence of ~ is the same as unary -, and |&^ all have the
// same precedence as + and -, unlike in reality, where the have different pre-
// cedences.
